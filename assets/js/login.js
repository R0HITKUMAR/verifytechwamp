...
stogglePassword.addEventListener("click", function (e) {
  const type =
    spassword.getAttribute("type") === "password" ? "text" : "password";
...
function loginadmin() {
  document.getElementById("lemail").value = "admin@verifytechwamp.ml";
  document.getElementById("lpassword").value = "Admin@1234";
  login();
}
